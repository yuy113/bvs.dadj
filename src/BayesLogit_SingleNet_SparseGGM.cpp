...
Rcpp::List BayesLogit_SingleNet_SparseGGM_UltraSparse(
    ...
    int proposal_type, int n_mh_gamma, int thin,
...
Rcpp::List BayesLogit_SingleNet_SparseGGM(
  ...
  return BayesLogit_SingleNet_SparseGGM_UltraSparse(
      X, y,
      ...
      eta_sd, mu_tilde, eta1_tilde, T_max,
      proposal_type, n_mh_gamma, thin,
